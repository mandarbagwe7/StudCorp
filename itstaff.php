  ...
  <div id="content">
    <div class="content_box">
      ...
      <?php
                ...
                $query = "SELECT i.iid, i.iname, i.ipost, d.dname, c.classname FROM instructor i inner join department d on i.did = d.did inner join class c on c.classid = i.classid where d.did = 2 order by i.iid";
