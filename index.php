  ...
  <div id="content">
    <div class="content_box">
      ...
      <div class="section_w250 float_r">
        <ul class="list_01">
          <li>Display Data Class-wise </li>
          <li>Display Data Department-wise </li>
          <li>Insert Student Data </li>
          <li>Insert Staff Data </li>
          <li>Insert Departments, Courses, Classes </li>
        </ul>
      </div>
      <div class="cleaner"></div>
    </div>
