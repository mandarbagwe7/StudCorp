...
<!--    </div>-->
  ...
  <div id="content">
    <div class="content_box">
      <h2>EXTC Staff Data:</h2>
      <?php
                $username = "root";
                $password = "";
                $database = "stducorp";
                $mysqli = new mysqli("localhost", $username, $password, $database);
                $query = "SELECT i.iid, i.iname, i.ipost, d.dname, c.classname FROM instructor i inner join department d on i.did = d.did inner join class c on c.classid = i.classid where d.did = 3 order by i.iid";
