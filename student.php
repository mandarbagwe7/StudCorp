  ...
  <div id="content">
    <div class="content_box">
      ...
      <?php
                ...
                $query = "SELECT s.sid,s.sname,s.sgender,s.saddress,d.dname,c.cname,class.classname FROM student s inner join courses c on c.cid=s.cid inner join department d on s.did = d.did inner join class on s.classid = class.classid order by s.sid";
