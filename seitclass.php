...
<!--    </div>-->
  ...
  <div id="content">
    <div class="content_box">
      <h2>Staff and Students from Class SE Information Technology:</h2>
      <?php
                $username = "root";
                $password = "";
                $database = "stducorp";
                $mysqli = new mysqli("localhost", $username, $password, $database);
                $query = "SELECT i.iid, i.iname, i.ipost, d.dname, c.classname FROM instructor i inner join department d on i.did = d.did inner join class c on c.classid = i.classid where c.classid = 2 order by i.iid";
